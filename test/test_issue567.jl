...
@testset "Issue567 Group Count Width" begin
    ...
    enc = Issue567.Issue567.Encoder(typeof(buffer))
    Issue567.Issue567.wrap_and_apply_header!(enc, buffer, 0; header=header)
    ...
    dec = Issue567.Issue567.Decoder(typeof(buffer))
    Issue567.Issue567.wrap!(dec, buffer, 0)
