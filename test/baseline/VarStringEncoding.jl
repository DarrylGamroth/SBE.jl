...
length_id(::VarStringEncoding) = UInt16(0xffff)
length_id(::Type{<:VarStringEncoding}) = UInt16(0xffff)
length_since_version(::VarStringEncoding) = UInt16(0x0)
length_since_version(::Type{<:VarStringEncoding}) = UInt16(0x0)
length_in_acting_version(m::VarStringEncoding) = sbe_acting_version(m) >= UInt16(0x0)
length_encoding_offset(::VarStringEncoding) = 0
length_encoding_offset(::Type{<:VarStringEncoding}) = 0
length_null_value(::VarStringEncoding) = UInt32(0xffffffff)
length_null_value(::Type{<:VarStringEncoding}) = UInt32(0xffffffff)
length_min_value(::VarStringEncoding) = UInt32(0x0)
length_min_value(::Type{<:VarStringEncoding}) = UInt32(0x0)
length_max_value(::VarStringEncoding) = UInt32(0x40000000)
length_max_value(::Type{<:VarStringEncoding}) = UInt32(0x40000000)
length_encoding_length(::VarStringEncoding) = 4
length_encoding_length(::Type{<:VarStringEncoding}) = 4
...
varData_id(::VarStringEncoding) = UInt16(0xffff)
varData_id(::Type{<:VarStringEncoding}) = UInt16(0xffff)
varData_since_version(::VarStringEncoding) = UInt16(0x0)
varData_since_version(::Type{<:VarStringEncoding}) = UInt16(0x0)
varData_in_acting_version(m::VarStringEncoding) = sbe_acting_version(m) >= UInt16(0x0)
varData_encoding_offset(::VarStringEncoding) = 4
varData_encoding_offset(::Type{<:VarStringEncoding}) = 4
varData_null_value(::VarStringEncoding) = UInt8(0xff)
varData_null_value(::Type{<:VarStringEncoding}) = UInt8(0xff)
varData_min_value(::VarStringEncoding) = UInt8(0x0)
varData_min_value(::Type{<:VarStringEncoding}) = UInt8(0x0)
varData_max_value(::VarStringEncoding) = UInt8(0xfe)
varData_max_value(::Type{<:VarStringEncoding}) = UInt8(0xfe)
varData_encoding_length(::VarStringEncoding) = -1
varData_encoding_length(::Type{<:VarStringEncoding}) = -1
