...
blockLength_id(::GroupSizeEncoding) = UInt16(0xffff)
blockLength_id(::Type{<:GroupSizeEncoding}) = UInt16(0xffff)
blockLength_since_version(::GroupSizeEncoding) = UInt16(0x0)
blockLength_since_version(::Type{<:GroupSizeEncoding}) = UInt16(0x0)
...
blockLength_encoding_offset(::Type{<:GroupSizeEncoding}) = 0
blockLength_null_value(::GroupSizeEncoding) = UInt16(0xffff)
blockLength_null_value(::Type{<:GroupSizeEncoding}) = UInt16(0xffff)
blockLength_min_value(::GroupSizeEncoding) = UInt16(0x0)
blockLength_min_value(::Type{<:GroupSizeEncoding}) = UInt16(0x0)
blockLength_max_value(::GroupSizeEncoding) = UInt16(0xfffe)
blockLength_max_value(::Type{<:GroupSizeEncoding}) = UInt16(0xfffe)
blockLength_encoding_length(::GroupSizeEncoding) = 2
blockLength_encoding_length(::Type{<:GroupSizeEncoding}) = 2
...
numInGroup_id(::GroupSizeEncoding) = UInt16(0xffff)
numInGroup_id(::Type{<:GroupSizeEncoding}) = UInt16(0xffff)
numInGroup_since_version(::GroupSizeEncoding) = UInt16(0x0)
numInGroup_since_version(::Type{<:GroupSizeEncoding}) = UInt16(0x0)
...
numInGroup_encoding_offset(::Type{<:GroupSizeEncoding}) = 2
numInGroup_null_value(::GroupSizeEncoding) = UInt16(0xffff)
numInGroup_null_value(::Type{<:GroupSizeEncoding}) = UInt16(0xffff)
numInGroup_min_value(::GroupSizeEncoding) = UInt16(0x0)
numInGroup_min_value(::Type{<:GroupSizeEncoding}) = UInt16(0x0)
numInGroup_max_value(::GroupSizeEncoding) = UInt16(0xfffe)
numInGroup_max_value(::Type{<:GroupSizeEncoding}) = UInt16(0xfffe)
numInGroup_encoding_length(::GroupSizeEncoding) = 2
numInGroup_encoding_length(::Type{<:GroupSizeEncoding}) = 2
