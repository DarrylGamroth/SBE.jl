...
export MessageHeader, MessageHeaderDecoder, MessageHeaderEncoder
...
Base.sizeof(m::MessageHeader) = sbe_encoded_length(m)
...
blockLength_id(::MessageHeader) = UInt16(0xffff)
blockLength_id(::Type{<:MessageHeader}) = UInt16(0xffff)
blockLength_since_version(::MessageHeader) = UInt16(0x0)
blockLength_since_version(::Type{<:MessageHeader}) = UInt16(0x0)
blockLength_in_acting_version(m::MessageHeader) = sbe_acting_version(m) >= UInt16(0x0)
blockLength_encoding_offset(::MessageHeader) = 0
blockLength_encoding_offset(::Type{<:MessageHeader}) = 0
blockLength_null_value(::MessageHeader) = UInt16(0xffff)
blockLength_null_value(::Type{<:MessageHeader}) = UInt16(0xffff)
blockLength_min_value(::MessageHeader) = UInt16(0x0)
blockLength_min_value(::Type{<:MessageHeader}) = UInt16(0x0)
blockLength_max_value(::MessageHeader) = UInt16(0xfffe)
blockLength_max_value(::Type{<:MessageHeader}) = UInt16(0xfffe)
blockLength_encoding_length(::MessageHeader) = 2
blockLength_encoding_length(::Type{<:MessageHeader}) = 2
...
templateId_id(::MessageHeader) = UInt16(0xffff)
templateId_id(::Type{<:MessageHeader}) = UInt16(0xffff)
templateId_since_version(::MessageHeader) = UInt16(0x0)
templateId_since_version(::Type{<:MessageHeader}) = UInt16(0x0)
templateId_in_acting_version(m::MessageHeader) = sbe_acting_version(m) >= UInt16(0x0)
templateId_encoding_offset(::MessageHeader) = 2
templateId_encoding_offset(::Type{<:MessageHeader}) = 2
templateId_null_value(::MessageHeader) = UInt16(0xffff)
templateId_null_value(::Type{<:MessageHeader}) = UInt16(0xffff)
templateId_min_value(::MessageHeader) = UInt16(0x0)
templateId_min_value(::Type{<:MessageHeader}) = UInt16(0x0)
templateId_max_value(::MessageHeader) = UInt16(0xfffe)
templateId_max_value(::Type{<:MessageHeader}) = UInt16(0xfffe)
templateId_encoding_length(::MessageHeader) = 2
templateId_encoding_length(::Type{<:MessageHeader}) = 2
...
schemaId_id(::MessageHeader) = UInt16(0xffff)
schemaId_id(::Type{<:MessageHeader}) = UInt16(0xffff)
schemaId_since_version(::MessageHeader) = UInt16(0x0)
schemaId_since_version(::Type{<:MessageHeader}) = UInt16(0x0)
schemaId_in_acting_version(m::MessageHeader) = sbe_acting_version(m) >= UInt16(0x0)
schemaId_encoding_offset(::MessageHeader) = 4
schemaId_encoding_offset(::Type{<:MessageHeader}) = 4
schemaId_null_value(::MessageHeader) = UInt16(0xffff)
schemaId_null_value(::Type{<:MessageHeader}) = UInt16(0xffff)
schemaId_min_value(::MessageHeader) = UInt16(0x0)
schemaId_min_value(::Type{<:MessageHeader}) = UInt16(0x0)
schemaId_max_value(::MessageHeader) = UInt16(0xfffe)
schemaId_max_value(::Type{<:MessageHeader}) = UInt16(0xfffe)
schemaId_encoding_length(::MessageHeader) = 2
schemaId_encoding_length(::Type{<:MessageHeader}) = 2
...
version_id(::MessageHeader) = UInt16(0xffff)
version_id(::Type{<:MessageHeader}) = UInt16(0xffff)
version_since_version(::MessageHeader) = UInt16(0x0)
version_since_version(::Type{<:MessageHeader}) = UInt16(0x0)
version_in_acting_version(m::MessageHeader) = sbe_acting_version(m) >= UInt16(0x0)
version_encoding_offset(::MessageHeader) = 6
version_encoding_offset(::Type{<:MessageHeader}) = 6
version_null_value(::MessageHeader) = UInt16(0xffff)
version_null_value(::Type{<:MessageHeader}) = UInt16(0xffff)
version_min_value(::MessageHeader) = UInt16(0x0)
version_min_value(::Type{<:MessageHeader}) = UInt16(0x0)
version_max_value(::MessageHeader) = UInt16(0xfffe)
version_max_value(::Type{<:MessageHeader}) = UInt16(0xfffe)
version_encoding_length(::MessageHeader) = 2
version_encoding_length(::Type{<:MessageHeader}) = 2
