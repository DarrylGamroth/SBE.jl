...
struct Decoder{T <: AbstractArray{UInt8}} <: AbstractCar{T}
    ...
    function Decoder(buffer::T, offset::Int64, position_ptr::PositionPointer) where T
        position_ptr[] = offset + UInt16(45)
        new{T}(buffer, offset, position_ptr, UInt16(45), UInt16(0x0000))
    end
end
...
@inline function Encoder(buffer::AbstractArray, offset::Integer = 0; position_ptr::PositionPointer = PositionPointer(), header::MessageHeader.Encoder = MessageHeader.Encoder(buffer, Int64(offset)))
        MessageHeader.blockLength!(header, UInt16(45))
...
export BoostType, BooleanType, Model, BoostType, OptionalExtras, MessageHeader, GroupSizeEncoding, VarStringEncoding, VarAsciiEncoding, VarDataEncoding, ModelYear, VehicleCode, Ron, SomeNumbers, Percentage, Booster, Engine, Car
end