...
@testset "Issue661 SinceVersion Set" begin
    ...
    dec0 = Issue661.Issue661.Decoder(buffer, 0, SBE.PositionPointer(), UInt16(0), UInt16(0))
    @test !Issue661.Issue661.set1_in_acting_version(dec0)

    dec1 = Issue661.Issue661.Decoder(buffer, 0, SBE.PositionPointer(), UInt16(0), UInt16(1))
