...
@testset "Since Deprecated Versions" begin
    ...
    enc = SinceDeprecated.SinceDeprecated.Encoder(buffer, 0; header=header)
    ...
    dec_v1 = SinceDeprecated.SinceDeprecated.Decoder(buffer, 0)
    ...
    dec_v2 = SinceDeprecated.SinceDeprecated.Decoder(buffer, 0)
    ...
    dec_v4 = SinceDeprecated.SinceDeprecated.Decoder(buffer, 0)
