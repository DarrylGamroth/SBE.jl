...
@testset "Issue1057 Set + Ref Composite" begin
    ...
    enc = Issue1057.ExecutionReportNew.Encoder(buffer, 0; header=header)
    ...
    dec = Issue1057.ExecutionReportNew.Decoder(buffer, 0)
    ...
    dec3 = Issue1057.ExecutionReportNew.Decoder(buffer, 0)
