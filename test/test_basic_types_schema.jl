...
@testset "Basic Types Schema" begin
    ...
    enc = BasicTypes.Message1.Encoder(buffer, 0; header=header)
    ...
    dec = BasicTypes.Message1.Decoder(buffer, 0)
    ...
    offset_enc = BasicTypes.Message1WithOffsets.Encoder(offset_buf, 0; header=offset_header)
    ...
    offset_dec = BasicTypes.Message1WithOffsets.Decoder(offset_buf, 0)
