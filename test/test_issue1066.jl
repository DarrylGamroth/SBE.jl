...
@testset "Issue1066 Optional Field SinceVersion" begin
    ...
    enc = Issue1066.Issue1066.Encoder(typeof(buffer))
    Issue1066.Issue1066.wrap_and_apply_header!(enc, buffer, 0; header=header)
    Issue1066.Issue1066.field!(enc, UInt16(7))

    dec = Issue1066.Issue1066.Decoder(typeof(buffer))
    Issue1066.Issue1066.wrap!(dec, buffer, 0)
    @test Issue1066.Issue1066.field(dec) == UInt16(7)

    Issue1066.MessageHeader.version!(header, UInt16(1))
    dec1 = Issue1066.Issue1066.Decoder(typeof(buffer))
    Issue1066.Issue1066.wrap!(dec1, buffer, 0)
