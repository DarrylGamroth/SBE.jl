...
@testset "Issue488 VarData" begin
    ...
    enc = Issue488Schema.Issue488.Encoder(typeof(buffer))
    Issue488Schema.Issue488.wrap_and_apply_header!(enc, buffer, 0; header=header)

    Issue488Schema.Issue488.varData!(enc, UInt8[0x01, 0x02, 0x03])

    dec = Issue488Schema.Issue488.Decoder(typeof(buffer))
    Issue488Schema.Issue488.wrap!(dec, buffer, 0)
