...
@testset "Issue987 Composite Offsets" begin
    ...
    enc = Issue987.Issue987.Encoder(typeof(buffer))
    Issue987.Issue987.wrap_and_apply_header!(enc, buffer, 0; header=header)

    comp = Issue987.Issue987.newField(enc)
    Issue987.NewComposite.f1!(comp, UInt16(123))
    Issue987.NewComposite.f2!(comp, UInt32(456))

    dec = Issue987.Issue987.Decoder(typeof(buffer))
    Issue987.Issue987.wrap!(dec, buffer, 0)
