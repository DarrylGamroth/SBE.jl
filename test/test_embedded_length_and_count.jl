...
@testset "Embedded Length and Count" begin
    ...
    enc1 = EmbeddedLengthAndCount.Message1.Encoder(buffer, 0; header=header)
    ...
    dec1 = EmbeddedLengthAndCount.Message1.Decoder(buffer, 0)
    ...
    enc2 = EmbeddedLengthAndCount.Message2.Encoder(buffer, 0; header=header)
    EmbeddedLengthAndCount.Message2.tag1!(enc2, UInt32(9))
    EmbeddedLengthAndCount.Message2.encryptedPassword!(enc2, "secret")

    dec2 = EmbeddedLengthAndCount.Message2.Decoder(buffer, 0)
