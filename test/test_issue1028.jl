...
@testset "Issue1028 Set SinceVersion in Composite" begin
    ...
    enc = Issue1028.ExecutionReportNew.Encoder(buffer, 0; header=header)
    ...
    dec = Issue1028.ExecutionReportNew.Decoder(buffer, 0)
    ...
    dec3 = Issue1028.ExecutionReportNew.Decoder(buffer, 0)
